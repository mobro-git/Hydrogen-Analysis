---
title: "TIMES H2 Analysis and Results: New Transmission and Distribution Build"
...
# source("h2_setup_01062021.R")
# source("h2_data_01062021.R")
# source("h2_results_01062021.R")
#rmarkdown::render(here("h2_reports/report_01062021.Rmd"))
```
...
```{r}
datatable(head(params, 6), class = 'cell-border stripe', options = list(autoWidth = TRUE, dom = 't'))
```
